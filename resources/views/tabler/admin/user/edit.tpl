                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3 row">
                                ...
                                <div class="col">
                                    <input id="pass" type="text" class="form-control" placeholder="若需为此用户重置密码, 填写此栏">
                                </div>
                            </div>
                            <div class="form-group mb-3 row">
                            ...
                            <div class="form-group mb-3 row">
                                ...
                                <div class="col">
                                    <input type="text" class="form-control" value="{$edit_user->last_check_in_time}"
                                        disabled />
                                </div>
                            </div>
                            <div class="form-group mb-3 row">
                                ...
                                <div class="col">
                                    <input type="text" class="form-control" value="{$edit_user->last_login_time}"
                                        disabled />
                                </div>
                            </div>
                        </div>
