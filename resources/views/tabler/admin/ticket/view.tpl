            ...
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    <div class="btn-list">
                        ...
                        <button href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-reply">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" data-bs-dismiss="modal" hx-post="/admin/ticket/{$ticket->id}"
