                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="telegram">
                                            <div class="card-body">
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col-auto">
                                                        <button class="btn btn-primary"
                                                            hx-post="/admin/setting/im/set_webhook/telegram"
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col">
                                                        <input id="telegram_webhook_token" type="text"
                                                            class="form-control"
                                                ...
                                                <div class="form-group mb-3 row">
                                                    <label class="form-label col-3 col-form-label">Bot Account
                                                        Username</label>
                                                    <div class="col">
                                        ...
                                        <div class="tab-pane" id="discord">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col">
                                                        <input id="discord_client_secret" type="text"
                                                            class="form-control"
                                                ...
                                                <div class="form-group mb-3 row">
                                                    <label class="form-label col-3 col-form-label">Discord Channel
                                                        ID</label>
                                                    <div class="col">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    <label class="form-label col-3 col-form-label">Discord User
                                                        ID/Channel
                                                        ID</label>
                                        ...
                                        <div class="tab-pane" id="slack">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    <label class="form-label col-3 col-form-label">Slack Channel
                                                        ID</label>
                                                    <div class="col">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    <label class="form-label col-3 col-form-label">Slack User ID/Channel
                                                        ID</label>
                                                    <input type="text" class="form-control" id="slack_channel_id"
                                                        value="">
                                                    <div class="row my-3">
                                                        <div class="col">
                                                            <button class="btn btn-primary"
