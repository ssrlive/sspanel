                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col">
                                                        <select id="display_docs" class="col form-select"
                                                            ...
                                                            <option value="1"
                                                                {if $settings['display_docs']}selected{/if}>开启
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col">
                                                        <select id="traffic_log" class="col form-select"
                                                            ...
                                                            <option value="1"
                                                                {if $settings['traffic_log']}selected{/if}>开启
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col">
                                                        <select id="login_log" class="col form-select"
                                                            ...
                                                            <option value="0"
                                                                {if ! $settings['login_log']}selected{/if}>关闭
                                                            </option>
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col">
                                                        <select id="enable_checkin" class="col form-select"
                                                            ...
                                                            <option value="1"
                                                                {if $settings['enable_checkin']}selected{/if}>开启
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
