                            ...
                            <div class="card">
                                <div class="card-header">
                                    <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs">
                                        ...
                                        <li class="nav-item">
                                            <a href="#alibabacloud" class="nav-link" data-bs-toggle="tab">AlibabaCloud
                                                DM</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="smtp">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    <label class="form-label col-3 col-form-label">Enable
                                                        TLS/SSL</label>
                                                    <div class="col">
                                                        <select id="smtp_ssl" class="col form-select"
                                                            value="{$settings['smtp_ssl']}">
                                                            <option value="0" {if ! $settings['smtp_ssl']}selected{/if}>
                                                                False
                                                            </option>
                                                            <option value="1" {if $settings['smtp_ssl']}selected{/if}>
                                                                True
                                                            </option>
                                                        </select>
                                                    </div>
                                        ...
                                        <div class="tab-pane" id="ses">
                                            <div class="card-body">
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col">
                                                        <input id="aws_ses_access_key_id" type="text"
                                                            class="form-control"
                                                ...
                                                <div class="form-group mb-3 row">
                                                    <label class="form-label col-3 col-form-label">Access Key
                                                        Secret</label>
                                                    <div class="col">
                                                        <input id="aws_ses_access_key_secret" type="text"
                                                            class="form-control"
                                        ...
                                        <div class="tab-pane" id="mailchimp">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col">
                                                        <input id="mailchimp_from_email" type="text"
                                                            class="form-control"
                                        ...
                                        <div class="tab-pane" id="alibabacloud">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col">
                                                        <input id="alibabacloud_dm_endpoint" type="text"
                                                            class="form-control"
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col">
                                                        <input id="alibabacloud_dm_from_alias" type="text"
                                                            class="form-control"
