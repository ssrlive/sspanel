                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <div class="page-pretitle my-3">
                                <span class="home-subtitle">{trans key='admin.llm.subtitle'}</span>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs">
                                        <li class="nav-item">
                                            <a href="#backend" class="nav-link active" data-bs-toggle="tab">{trans key='admin.llm.tabs.settings'}</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a href="#huggingface" class="nav-link" data-bs-toggle="tab">Hugging
                                                Face</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#cf-workers-ai" class="nav-link" data-bs-toggle="tab">Cloudflare
                                                Workers
                                                AI</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <div class="tab-pane" id="vertex-ai">
                                            <div class="card-body">
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col">
                                                        <input id="vertex_ai_access_token" type="text"
                                                            class="form-control"
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col">
                                                        <input id="vertex_ai_project_id" type="text"
                                                            class="form-control"
                                        ...
                                        <div class="tab-pane" id="huggingface">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col">
                                                        <input id="huggingface_endpoint_url" type="text"
                                                            class="form-control"
                                        ...
                                        <div class="tab-pane" id="cf-workers-ai">
                                            <div class="card-body">
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col">
                                                        <input id="cf_workers_ai_account_id" type="text"
                                                            class="form-control"
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col">
                                                        <input id="cf_workers_ai_api_token" type="text"
                                                            class="form-control"
                                                ...
                                                <div class="form-group mb-3 row">
                                                    <label class="form-label col-3 col-form-label">Model ID</label>
                                                    <div class="col">
                                                        <input id="cf_workers_ai_model_id" type="text"
                                                            class="form-control"
                                        ...
                                        <div class="tab-pane" id="aws-bedrock">
                                            <div class="card-body">
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col">
                                                        <input id="aws_bedrock_access_key_id" type="text"
                                                            class="form-control"
                                                            value="{$settings['aws_bedrock_access_key_id']}">
                                                    </div>
                                                </div>
                                                <div class="form-group mb-3 row">
                                                    <label class="form-label col-3 col-form-label">Access Key
                                                        Secret</label>
                                                    <div class="col">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    <label class="form-label col-3 col-form-label">Model ID</label>
                                                    <div class="col">
                                                        <input id="aws_bedrock_model_id" type="text"
                                                            class="form-control"
