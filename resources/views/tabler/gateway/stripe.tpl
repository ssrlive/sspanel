<link rel="stylesheet" href="//{$config['jsdelivr_url']}/npm/@tabler/core@latest/dist/css/tabler-payments.min.css">
...
<div class="card-inner">
    ...
    <div class="form-group form-group-label">
        <button class="btn btn-flat waves-attach" hx-post="/user/payment/purchase/stripe" hx-swap="none" hx-vals='js:{
