                            ...
                            <div class="tab-content">
                                <div class="tab-pane active show" id="sub">
                                    <div>
                                        ...
                                        <div class="btn-list justify-content-start">
                                            <a data-clipboard-text="{$UniversalSub}/json" class="copy btn btn-primary">
                                                复制通用订阅（Json）
                                            </a>
                                            <a data-clipboard-text="{$UniversalSub}/clash" class="copy btn btn-primary">
                                                复制通用订阅（Clash）
                                            </a>
                                ...
                                <div class="tab-pane show" id="client-sub">
                                    <div>
                                        ...
                                        <div class="btn-list justify-content-start">
                                            {if $public_setting['enable_ss_sub']}
                                                <a data-clipboard-text="{$UniversalSub}/ss" class="copy btn btn-primary">
                                                    复制客户端订阅（Shadowsocks）
                                                </a>
                                            ...
                                            {/if}
                                            {if $public_setting['enable_v2_sub']}
                                                <a data-clipboard-text="{$UniversalSub}/v2ray" class="copy btn btn-primary">
                                                    复制客户端订阅（V2Ray）
                                                </a>
                                            {/if}
                                            {if $public_setting['enable_trojan_sub']}
                                ...
                                <div class="tab-pane" id="windows">
                                    <div>
                                        ...
                                        <div class="btn-list justify-content-start my-2">
                                            <a {if $config['enable_r2_client_download']}
                                                href="/user/clients/Hiddify.exe" {else} href="/clients/Hiddify.exe"
                                ...
                                <div class="tab-pane" id="macos">
                                    ...
                                    <div class="btn-list justify-content-start">
                                        <a {if $config['enable_r2_client_download']}
                                            ...
                                            href="/clients/Clash.Nyanpasu_aarch64.dmg" {/if} class="btn btn-azure">
                                    ...
                                    <div class="btn-list justify-content-start my-2">
                                        <a {if $config['enable_r2_client_download']} href="/user/clients/SFM.zip" 
                                        {else}
                                            href="/clients/SFM.zip" {/if} class="btn btn-azure">
                                            下载 SFM
                                        </a>
                                        <a data-clipboard-text="{$UniversalSub}/singbox" class="copy btn btn-primary">
                                            复制 SingBox 订阅链接
                                        </a>
                                    ...
                                    <div class="btn-list justify-content-start my-2">
                                        <a {if $config['enable_r2_client_download']} href="/user/clients/Hiddify.dmg"
                                            {else} href="/clients/Hiddify.dmg" 
                                            {/if} class="btn btn-azure">
                                            下载 Hiddify
                                        </a>
                                        <a data-clipboard-text="{$UniversalSub}/singbox" class="copy btn btn-primary">
                                ...
                                <div class="tab-pane" id="android">
                                    ...
                                    <div class="btn-list justify-content-start">
                                        <a {if $config['enable_r2_client_download']} href="/user/clients/CMFA.apk"
                                            {else} href="/clients/CMFA.apk" 
                                            {/if} class="btn btn-azure">
                                    ...
                                    <div class="btn-list justify-content-start my-2">
                                        <a {if $config['enable_r2_client_download']} href="/user/clients/SFA.apk" 
                                        {else}
                                            href="/clients/SFA.apk" {/if} class="btn btn-azure">
                                            下载 SFA
                                        </a>
                                        <a data-clipboard-text="{$UniversalSub}/singbox" class="copy btn btn-primary">
                                            复制 SingBox 订阅链接
                                    ...
                                    <div class="btn-list justify-content-start my-2">
                                        <a {if $config['enable_r2_client_download']} href="/user/clients/Hiddify.apk"
                                            {else} href="/clients/Hiddify.apk" 
                                            {/if} class="btn btn-azure">
                                            下载 Hiddify
                                        </a>
                                        <a data-clipboard-text="{$UniversalSub}/singbox" class="copy btn btn-primary">
