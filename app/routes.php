...
return static function (Slim\App $app): void {
    ...
    $app->group('/admin', static function (RouteCollectorProxy $group): void {
        ...
        $group->post('/order/{id:[0-9]+}/mark_paid', App\Controllers\Admin\OrderController::class . ':markPaid');
        $group->post('/order/{id:[0-9]+}/force_activate', App\Controllers\Admin\OrderController::class . ':forceActivate');
